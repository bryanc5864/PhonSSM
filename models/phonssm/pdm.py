"""PDM: split spatial features into four Stokoe-style subspaces -
handshape, location, movement, orientation. unsupervised, no phoneme labels.
"""
import torch
...
class PhonologicalDisentanglement(nn.Module):
    """split spatial features into 4 phonological subspaces.

    per-component encoders, cross-component attention for interactions, and an
    orthogonality penalty to keep the subspaces from collapsing together.
    """
